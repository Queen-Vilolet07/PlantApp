...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.quantity.setText(cartModelList.get(position).getTotalQuantity()+" Piece");
        holder.totalPrice.setText(String.valueOf(cartModelList.get(position).getTotalPrice()+" Tk"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView name,product_price,date,time,quantity,totalPrice;
